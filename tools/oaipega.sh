...
sudo ip link set ens1f0 vf 0 mac 00:11:22:33:44:66 vlan 3 qos 0 spoofchk off mtu 9000
sudo ip link set ens1f0 vf 1 mac 00:11:22:33:44:66 vlan 3 qos 0 spoofchk off mtu 9000
sleep 1

# These are the DPDK bindings for C/U-planes on vlan
# unbind
sudo /usr/local/bin/dpdk-devbind.py --unbind 70:02.0
sudo /usr/local/bin/dpdk-devbind.py --unbind 70:02.1

# reload "Virtual Function I/O" driver 
sudo modprobe vfio_pci

# bind
sudo /usr/local/bin/dpdk-devbind.py --bind vfio-pci 70:02.0
sudo /usr/local/bin/dpdk-devbind.py --bind vfio-pci 70:02.1
...
# show the setting
sudo ethtool -g ens1f0

# show the setting
sudo ifconfig ens1f0